...
Imagine first that households *could* fully insure — every bad year is covered, so income is effectively smooth and certain. We call this the **representative-agent** world (everyone ends up behaving identically).
